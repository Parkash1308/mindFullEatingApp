...
class effectivityLongtern extends StatefulWidget {
  const effectivityLongtern({super.key});

  @override
  State<effectivityLongtern> createState() => _effectivityLongternState();
}

class _effectivityLongternState extends State<effectivityLongtern> {
  @override
      ...
      appBar: AppBar(
        ...
        body: SingleChildScrollView(
          child: Padding(
              ...
              children: [
              createMindfuldiaryText3("Enter note about long term effectiveness"),
              Padding(
